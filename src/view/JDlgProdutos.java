...
public class JDlgProdutos extends javax.swing.JDialog {
    ...
    private void habilitar(boolean status) {
        if (status) {
            Util.habilitar(true, jTxtCodigo, jTxtNome, jTxtDescricao, jTxtMarca, jTxtEstoque, jTxtPreco, jTxtTamanho, jTxtDataDeFabricacao,
                    jBtnCancelar, jBtnConfirmar);
            Util.habilitar(false, jBtnIncluir, jBtnAlterar, jBtnPesquisar, jBtnExcluir);
        } else {
            Util.habilitar(false, jTxtCodigo, jTxtNome, jTxtDescricao, jTxtMarca, jTxtEstoque, jTxtPreco, jTxtTamanho, jTxtDataDeFabricacao,
                    jBtnCancelar, jBtnConfirmar);
